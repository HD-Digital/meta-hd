...
IMAGE_CMD_hd-emmc () {
    ...
    echo "boot emmcflash0.kernel1 'root=/dev/mmcblk0p3 rw rootwait hd51_4.boxmode=12'" > ${WORKDIR}/STARTUP
    echo "boot emmcflash0.kernel1 'root=/dev/mmcblk0p3 rw rootwait hd51_4.boxmode=1'" > ${WORKDIR}/STARTUP_1
    echo "boot emmcflash0.kernel2 'root=/dev/mmcblk0p5 rw rootwait hd51_4.boxmode=1'" > ${WORKDIR}/STARTUP_2
    echo "boot emmcflash0.kernel3 'root=/dev/mmcblk0p7 rw rootwait hd51_4.boxmode=1'" > ${WORKDIR}/STARTUP_3
    echo "boot emmcflash0.kernel4 'root=/dev/mmcblk0p9 rw rootwait hd51_4.boxmode=1'" > ${WORKDIR}/STARTUP_4
